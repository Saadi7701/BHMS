  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white sticky top-0 z-40 shadow-md transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {/* Center: Active Logged-In Workspace Badge Only */}
        <div className="flex items-center gap-2.5 px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl border bg-slate-50 dark:bg-slate-800/80 shadow-inner max-w-[200px] sm:max-w-none">
          <div className={`p-1.5 rounded-lg border ${portalObj.color} shrink-0`}>
            <IconComp className="w-4 h-4" />
          </div>
          <div className="overflow-hidden">
            <div className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider leading-none truncate">
